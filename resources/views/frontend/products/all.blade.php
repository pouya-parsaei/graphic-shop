                ...
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                    ...
                    <div class="filter-col2 p-r-15 p-b-27">
                        ...
                        <ul>
                            ...
                            <li class="p-b-6">
                                <a href="?filter=price&action=limit&value=10to100" class="filter-link stext-106 trans-04">
                                    ۱۰ الی ۱۰۰ هزار تومان
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?filter=price&action=limit&value=101to200" class="filter-link stext-106 trans-04">
                                    ۱۰۱ الی ۲۰۰ هزار تومان
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="?filter=price&action=limit&value=201to300" class="filter-link stext-106 trans-04">
